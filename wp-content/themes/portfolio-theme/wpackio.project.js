...
module.exports = {
	// Project Identity
	appName: 'portfolioTheme', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'portfolio-theme', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	...
	files: [
		...
		//      // global namespace pollutions 😉
		 		assets: './assets/scripts/main.js', // Could be a string
